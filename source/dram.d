...
struct Dram
{
    ...
    ulong load(ulong addr, ulong size)
    {
        ...
        {
        case 8:
            return cast(ulong) dram.peek!(ubyte, Endian.littleEndian)(addr - DRAM_BASE);
        case 16:
            return cast(ulong) dram.peek!(ushort, Endian.littleEndian)(addr - DRAM_BASE);
        case 32:
            return cast(ulong) dram.peek!(uint, Endian.littleEndian)(addr - DRAM_BASE);
        case 64:
            return dram.peek!(ulong, Endian.littleEndian)(addr - DRAM_BASE);
        default:
            assert(0, "Unknown size " ~ size.to!string);
        }
    }
